...
public class JhipsterSampleMicroserviceKafkaResource {
    ...
    private final Logger log = LoggerFactory.getLogger(JhipsterSampleMicroserviceKafkaResource.class);
    ...
    public JhipsterSampleMicroserviceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
