...
describe('Store e2e test', () => {
  ...
  const storeSample = { name: 'Mountains wireless Market', address: 'overriding', createTimestamp: '2022-10-19T17:36:25.664Z' };
  ...
  describe('new Store page', () => {
    ...
    it('should create an instance of Store', () => {
      ...
      cy.get(`[data-cy="createTimestamp"]`).type('2022-10-20T02:54').blur().should('have.value', '2022-10-20T02:54');

      cy.get(`[data-cy="updateTimestamp"]`).type('2022-10-19T13:43').blur().should('have.value', '2022-10-19T13:43');
